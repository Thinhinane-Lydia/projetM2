...
//   if (productInfo) {
//     sendNotification({
//       userId: productInfo.seller,
//       type: "comment",
//       message: `Un utilisateur a commenté votre produit "${productInfo.name}".`,
//       productId: product,
...
//   if (productInfo) {
//     sendNotification({
//       userId: productInfo.seller, // Envoyer au vendeur
//       type: "comment",
//       message: `Un nouvel utilisateur a commenté votre produit "${productInfo.name}".`,
//       productId: product,
//       commentId: comment._id,
//     });
//   }
...
//   // Ajouter un indicateur pour identifier l'utilisateur courant
//   const enhancedComments = comments.map(comment => {
//     const commentObj = comment.toObject();
//     if (req.user && comment.user && comment.user._id) {
//       commentObj.user.isCurrentUser = comment.user._id.toString() === req.user.id;
//     }
//     return commentObj;
//   });
