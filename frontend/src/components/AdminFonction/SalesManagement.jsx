...
//                                       <img 
//           src={`http://localhost:8000${item.product.images[0].url}`}  // Assurez-vous que l'URL de l'image est correcte
...
//                                     <p className="text-sm font-semibold text-amber-700">{item.price.toFixed(2)} DA</p> {/* Affichage en Dinar Algérien */}
//                                   </div>
//                                 </div>
//                               ))}
//                             </div>
...
//                     <p className="text-amber-800 font-semibold">{selectedOrder.total.toFixed(2)} DA</p> {/* Affichage en Dinar Algérien */}
//                   </div>
//                 </div>
//               </div>
...
//                     <img 
//                       src={`http://localhost:8000${selectedOrder.user?.profileImage?.url || '/default-avatar.png'}`}
...
//                           <p className="font-medium text-amber-800">{item.product?.name || 'Produit inconnu'}</p>
//                           <p className="font-semibold text-amber-700">{item.price.toFixed(2)} DA</p> {/* Affichage en Dinar Algérien */}
//                         </div>
//                         <p className="text-sm text-gray-600 mt-1">{item.product?.description?.substring(0, 100) || 'Sans description'}...</p>
//                         <div className="mt-2 flex items-center">
//                           <div className="w-6 h-6 rounded-full overflow-hidden mr-2">
//                             <img 
//                               src={`http://localhost:8000${item.seller?.profileImage?.url || '/default-avatar.png'}`}
