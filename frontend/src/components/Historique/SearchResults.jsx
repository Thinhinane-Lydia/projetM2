...
//   // Récupérer l'historique des recherches au montage du composant
//   useEffect(() => {
...
// //         return images[0].url;
// //       }
// //       // If the URL is relative, prepend the server URL
...
// //   };
// const getImageUrl = (images) => {
//     console.log("🔍 Full product:", product); // Log entire product object
...
//         Aucun produit trouvé dans l'historique des recherches.
//       </div>
//     );
//   }
