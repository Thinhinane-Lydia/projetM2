...
// // Composant MiniRatingSelector pour la sélection des étoiles - version taille moyenne
...
//           className="ml-2 text-sm flex items-center bg-neutral-100 py-0.5 px-2 rounded-full"
//         >
...
// // Composant MiniRatingDisplay pour l'affichage des étoiles en lecture seule - version taille moyenne
...
//             <svg viewBox="0 0 24 24" className="w-4 h-4 text-neutral-200">
//               <path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z" fill="currentColor" />
//             </svg>
...
//             initial={{ opacity: 0 }}
//             animate={{ opacity: 1 }}
//             className="font-medium bg-gradient-to-r from-amber-500 to-amber-600 text-transparent bg-clip-text"
//           >
...
//             className="mb-5 bg-neutral-50 p-4 rounded-lg border border-neutral-100"
//           >
//             <div className="mb-3">
...
//               <textarea
//                 className="w-full p-3 border border-neutral-200 rounded-lg focus:ring focus:ring-amber-200 focus:border-amber-500 outline-none transition bg-white text-sm"
//                 rows="2"
...
//               whileTap={{ scale: 0.98 }}
//               className="px-4 py-2 bg-gradient-to-r from-amber-500 to-amber-600 text-white text-sm rounded-lg hover:shadow-md transition flex items-center justify-center"
//             >
...
//           </motion.form>
//         ) : (
//           <div className="mb-5 bg-neutral-50 p-4 rounded-lg border border-neutral-100 text-center">
//             <p className="text-neutral-600 mb-3 text-sm">Vous devez être connecté pour laisser un avis.</p>
//             <button 
//               onClick={() => navigate("/login")} 
//               className="px-4 py-2 bg-gradient-to-r from-amber-500 to-amber-600 text-white text-sm rounded-lg hover:shadow-md transition flex items-center justify-center mx-auto"
//             >
//               <FiSend className="mr-1.5" size={14} />
//               Se connecter
//             </button>
...
//                         <div className="w-8 h-8 bg-gradient-to-br from-amber-100 to-amber-50 rounded-full flex items-center justify-center mr-2 shadow-sm">
...
//                       )}
//                     </div>
//                     <p className="mt-2 text-neutral-700 bg-white p-2.5 rounded-lg text-sm">{comment.text}</p>
//                   </motion.div>
//                 ))}
//               </div>
//             </AnimatePresence>
